let data = {
    projects: [

        {
            ...
            class: ['all', 'html', 'js'],
            tools: 'HTML/CSS/JS',
            bg: 'url(cases/0/andrewBrown.jpeg) left/cover no-repeat',
            modal: {
                images: [
                        'cases/0/img/1.jpeg',
                        'cases/0/img/2.jpeg',
                ...
                clientLink: '',
                price: '15000р.',
                link: 'cases/0/src/index.html',
                projectName: 'Сайт-визитка',
                aboutProject: 'Это мой первый полностью созднанный шаблон. Если его залить на хостинг то будет полноценный сайт.'
            },
            },
        {
            // название проекта
            ...
            tools: 'Java Script',
            // фон
            bg: 'url(cases/1/helloWorld.jpeg) left/cover no-repeat',
            ...
            modal: {
                ...
                clientLink: '',
                // стоимость
                price: 'Куриный доширак',
                // ссылка
                link: 'cases/1/src/index.html',
                // имя проекта
                projectName: 'Кликер "Hello World"',
                // описание
                aboutProject: 'Это нужно увидеть самому...'
                },
            },
    ...
    blog: [
            ...
            },
        {
            ...
            content: [
                {
                    secondTitle: '1. Emmet',
                    text: ['Пожалуй одно из самых популярных расширений для вёрстки в целом является Emmet. Он позволяет писать CSS и HTML код быстрее с помощью аббревиатур, разворачивающихся в полноценные теги.', 'Ссылка на гитхаб:', {
                        type: 'link',
                        link: 'https://github.com/emmetio/brackets-emmet',
                        linkName: 'github.com/emmetio/brackets-emmet'
                    }],
                    },
                {
                    secondTitle: '2. Beautify',
                    text: ['Этот плагин позволяет сочетание клавиш CTRL + ALT + B оформить структуру разметки с отступами и сделает её читабельной.', {
                        type: 'link',
                        link: 'https://github.com/brackets-beautify/brackets-beautify',
                        linkName: 'github.com/brackets-beautify/brackets-beautify'
                    }],
                    },
                ],
            },
